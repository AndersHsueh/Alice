...
```bash
# issue 回归套件(当前基线 168 + 51 + 45 + 96 + 40 + 47 = 447 断言)
for t in 001 002 003 004 005 009 010 011 012 013 019 020 021; do bun run test-case/test-issue-$t.ts || exit 1; done
```
