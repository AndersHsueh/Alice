...
「我是一个不懂技术的产品经理, 我想通过 Mermaid 图表深度梳理一下业务。帮我分析一下这里面有哪些值得挖掘的点。写几篇逻辑详尽的说明文档，放在 docs/explain/*.md 。文档里要大量运用 Mermaid 语法来可视化这些逻辑，越详细越好,越详细越好,越详细越好，哪怕我不懂技术也能一眼看清业务逻辑的走向。」
