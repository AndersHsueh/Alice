...
class SupportsStreamingMessages:
    """Protocol for streaming message API clients."""
...
# --- Tool registry and execution context (imported from tools module) ---
from oh_flow.tools.base import ToolRegistry, ToolExecutionContext  # noqa: E402

# --- Permission checker (imported from permissions module) ---
from oh_flow.permissions.checker import PermissionChecker  # noqa: E402

# --- Hook executor (imported from hooks module) ---
from oh_flow.hooks import HookExecutor  # noqa: E402

# --- Auto-compaction state (simplified) ---
...
async def auto_compact_if_needed(
    ...
    # Simplified: no auto-compaction in v1
    # Full implementation would estimate token count and compact
