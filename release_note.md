...
## 📝 Wiki Ingest 记录(2026-08-14)

> `wiki/` 在 `.gitignore` 中,本地知识库,不入 git。本节是 ingest 完成的轨迹记录,以便 release 节点 push 时携带证据。

- **新建主题页**:`wiki/v3.0.1-rollout.md`(本次 rollout 完整记录,含 21 issue 索引 / 决策 / 落地工作 / 已知限制)
- **更新主题页**:`wiki/INDEX.md`(主题清单 16 → 17,加 #17 v3.0.1-rollout;速查表加 4 行:当前版本 / 17 项优化行动 / 21 issue rollout / 0 个现有 issue)
- **追加 log 条目**:`wiki/log.md` 新增 6 条:
  - `[2026-08-14] workflow` v3.0.1 rollout Plan + 第一阶段执行
  - `[2026-08-14] wiki` A1 · 重写版本叙事 0.x → 3.x
  - `[2026-08-14] lint` C1 · 第一阶段 + A1 重写后跑 lint(SUMMARY 0 真问题)
  - `[2026-08-14] deliverable` B3 · 创建 21 个 issue 到 gitee
  - `[2026-08-14] commit` a104d85 chore · 清理 obsolete 文档
  - `[2026-08-14] deliverable` release_note.md + README v3.0.1(commit f114a95)
  - `[2026-08-14] wiki` v3.0.1-rollout.md 主题页首次新建
- **lint 终态**:`SUMMARY: broken=1 orphans=1 lowlinks=0 nosummary=0 nostamp=0`(真问题 0,broken/orphan 是「借鉴与学习」Windows GBK 终端显示截断假阳性)
- **wiki 主题数**:16 → 17(新增 v3.0.1-rollout.md)
- **log.md 总条目数**:22 → 28(本 release 增加 6 条)
