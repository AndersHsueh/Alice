...
[![Version](https://img.shields.io/badge/version-0.5.0-blue.svg)](https://github.com/AndersHsueh/Alice)
...
- **[Qwen-Code](https://github.com/QwenLM/Qwen2.5-Code)** - 工具调用（Function Calling）结构与实现参考
