...
- `anthropic` / `claude` - Anthropic Claude 云服务
- `google` / `gemini` - Google Gemini 云服务
- `mistral` - Mistral AI 云服务
...
**默认**: `10`  
**范围**: 5 - 20  
**说明**: 工具调用最大迭代次数，超出范围自动使用默认值 10

在复杂任务中，AI 可能需要多次调用工具。此配置限制单次对话中工具调用的最大轮数。
